            ...
            <div className="flex flex-col-reverse py-20 -mx-4 lg:flex-row 2xl:py-40">
                ...
                <div className="w-full px-4 mb-8 lg:w-2/5 lg:mb-0">
                    ...
                    <div className="flex items-center mb-6">
                        ...
                        <p className="text-lg font-semibold text-gray-600 dark:text-gray-400">+916393033721</p>
                    </div>
                    <div className="flex items-center mb-6">
                        <span
                            className="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg dark:text-gray-400 dark:bg-gray-700">
                        ...
                        <p className="text-lg font-semibold text-gray-600 dark:text-gray-400">theworldkanpur@gmail.com</p>
                    </div>
                    <div className="flex items-center mb-6">
                        <span
                        ...
                        <div>
                            <p className="mb-2 text-lg font-semibold text-gray-600 dark:text-gray-400">Karhi Road, Barra By-pass, Kanpur, Uttar Pradesh
                            </p>
                        </div>
                    </div>
                </div>
